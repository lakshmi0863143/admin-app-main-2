...
class edit_form(edit_formTemplate):
  def __init__(self, **properties):
    ...
    if a == -1:
      ...
      self.text_box_1.text = self.id_list[-1]
  ...
  def button_1_click(self, **event_args):
    ...
    if self.text_box_1.text == "" or self.text_box_2.text == ""  or self.text_box_3.text == "" or self.text_box_4.text  == "" or  self.drop_down_2.selected_value == "" or   self.drop_down_3.selected_value == "" or self.drop_down_4.selected_value == "" or self.text_box_5.text == "":
